  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/dipaksingh3323@gmail.com",
        {
          method: "POST",
          body: form,
        }
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0">
        <div className="flex-1 text-center md:text-left">
          ...
          >
            <a href="https://github.com/DipakSingh0111">
              <FaGithub className="text-3xl hover:text-[#d97706]" />
            </a>
            <a href="https://www.linkedin.com/in/dipak-singh-91bbbb226/">
        ...
        <div className="flex-1 mt-6 md:mt-0">
          <form
            className="bg-[#1E1C1C] p-8  shadow-lg"
